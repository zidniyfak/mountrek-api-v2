...
<head>
    ...
    <link rel="icon" href="{{ asset('storage/users/m.png') }}" type="image/x-icon" />
    @yield('title')
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('storage/users/m.png') }}" alt="AdminLTELogo" height="60"
                width="60" />
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('storage/users/m.png') }}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('storage/users/default.jpg') }}" class="img-circle elevation-2"
                            alt="User Image" />
                    </div>
                    <div class="info">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024
                <a href="https://adminlte.io">Mountrek</a>.</strong>
            All rights reserved.
